...
@Data
@Component
public class StarMatcher implements Step {
    ...
    public MatchResponse matches(String text) {
        ...
        System.out.println("temp " + temp + " count " + prefixCount + " index " + lastIndex);
        boolean result =  prefixCount >= 0 && checkSuffix(text, lastIndex);
